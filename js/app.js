...
***************************************************************************** */
    ...
    window.onload = function() {
        ...
        function documentActions(e) {
            ...
            if (targetElement.classList.contains("search-form__icon")) document.querySelector(".search-form").classList.toggle("_active"); else if (!targetElement.closest(".search-form") && document.querySelectorAll(".search-form._active").length > 0) document.querySelector(".search-form").classList.remove("_active");
        ...
        function loadProducts(data) {
            ...
            data.products.forEach((item => {
                ...
                let productTemplateImg = `\n    <a href="${productUrl}" class="item-product__image item-product__image-ibg">\n\t\t\t<img src="img/products/${productImage}" alt="${productTitle}">\n\t\t</a>`;
                let productTemplateBodyStart = `<div class="item-product__body ">`;
                let productTemplateBodyEnd = `</div>`;
                let productTemplateBodyContent = `\n    <div class="item-product__content">\n\t\t\t<h5 class="item-product__title">${productTitle}</h5>\n\t\t\t<div class="item-product__text">${productText}\n    </div>`;
                let productTemplatePrices = "";
                let productTemplatePricesStart = '<div class="item-product__prices">';
                let productTemplatePricesCurrent = `<div class="item-product__price">${productPrice}</div>`;
                let productTemplatePricesOld = `<div class="item-product__price_old">${productOldPrice}</div>`;
                let productTemplatePricesEnd = "</div>";
                productTemplatePrices += productTemplatePricesStart;
                productTemplatePrices += productTemplatePricesCurrent;
                if (productTemplatePricesOld) productTemplatePrices += productTemplatePricesOld;
                ...
                let template = "";
                template += productTemplateStart;
                template += productTemplateLabels;
                template += productTemplateImg;
                template += productTemplateBody;
                template += productTemplateEnd;
        ...
        function addToCart(productButton, productId) {
            if (!productButton.classList.contains("_hold")) {
                ...
                const cartFyLeft = cart.getBoundingClientRect().left;
                const cartFyTop = cart.getBoundingClientRect().top;
                productImageFly.style.cssText = `\n        left: ${cartFyLeft}px;\n        top: ${cartFyTop}px;\n        width: 0px;\n        height: 0px;\n        opacity: 0;\n      `;
        ...
        function updateCart(productButton, productId, productAdd = true) {
            ...
            if (productAdd) {
                ...
                if (!cartProduct) {
                    ...
                    const cartProductContent = `\n        <a href="" class="cart-list__image cart-list__image-ibg">${cartProductImage}</a>\n        <div class="cart-list__body">\n          <a href="" class="cart-list__title">${cartProductTitle}</a>\n          <div class="cart-list__quantity">Quantity: <span>1</span></div>\n          <a href="" class="cart-list__delete">Delete</a>\n        </div>\n        `;
